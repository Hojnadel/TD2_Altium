...
#define	FCLK_FAST()		Chip_SSP_SetBitRate(LPC_SSP1, 1000000)   /* Set fast clock (depends on the CSD) */

//El slow lo puse a 400kHz y el fast a 25MHz, el slow 100-400k y el fast depende del tipo de tarjeta
...
void disk_timerproc (void)
{
	...
	//pv = (Chip_GPIO_GetPinState(LPC_GPIO, 2, 1) != 0); //Ver que mierda es este pin
